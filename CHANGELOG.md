...
- Subsample mitochondrial alignments from genome alignment BAM files instead of from BAM files generated by the mitochondrial subworkflow. [GMS #8](https://github.com/genomic-medicine-sweden/raredisease/pull/8)
