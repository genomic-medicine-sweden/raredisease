...
## v2.5.6 - Fulliautomatix (patch) [2026-01-xx]

### `Added`

- Set MT SNVs to homoplasmic when GT >=0.95 [GMS #21](https://github.com/genomic-medicine-sweden/raredisease/pull/21)

## v2.5.5 - Fulliautomatix (patch) [2025-12-19]
...
- Call SVs in mitochondria using mitochondrial alignments in the genome alignment files instead of from BAM files generated by the mitochondrial subworkflow. [GMS #8](https://github.com/genomic-medicine-sweden/raredisease/pull/8)
- Don't call mobile elements in mitochondrial DNA. [GMS #10](https://github.com/genomic-medicine-sweden/raredisease/pull/10)
- Remove mitochondrial SVs identified by CNVnator. [GMS #13](https://github.com/genomic-medicine-sweden/raredisease/pull/13)

### `Fixed`

- Fixed issue with the retroseq mobile element caller where the calling failed on unplaced contigs [GMS #9](https://github.com/genomic-medicine-sweden/raredisease/pull/9)

## v2.5.3 - Fulliautomatix (patch) [2025-10-02]

### `Changed`

- Replace d4 output of mosdepth with d4tools, and add mosdepth per_base_bed output. [GMS #5](https://github.com/genomic-medicine-sweden/raredisease/pull/5)
